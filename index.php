...
<html>
	<head>
		...
		<title>Escargot 41© Classic French Cuisine</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://www.escargot41.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a class="ui-btn buttons-radius" href="tel:<?php echo $telephone ?>">Call US</a></div>
					...
					<div class="ui-block-b" id="findUS">
						<script>
							...
							if(/Android|webOS|Opera Mini/i.test(navigator.userAgent) ) {
								...
								dugme.setAttribute('class', "ui-btn buttons-radius");
				...
				<div class="ui-grid-b" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Menu</a></div>
					<div class="ui-block-b buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Wines</a></div>
					<div class="ui-block-c buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Press</a></div>
				</div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Reservations</a>
					</div>
				</div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Wines</a></li>
